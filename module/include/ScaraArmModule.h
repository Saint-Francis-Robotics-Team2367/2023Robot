...
class ScaraArmModule {
    ...
    frc::DigitalInput * innerRightSwitch = new frc::DigitalInput(9);
    frc::DigitalInput * outterLeftSwitch = new frc::DigitalInput(9);
    frc::DigitalInput * outterRightSwitch = new frc::DigitalInput(9);
